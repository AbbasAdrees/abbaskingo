...
logo = """
    ...
    亗⧼Aββɑʂ⏤͟͟͞͞★⧽►↺【❼❽❻】【𝐊𝐈𝐍𝐆】【𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊】Author: Abbas-Adrees-HACKER
"""
...
def menu():
    ...
    print 
    print ''
    print'FB OLD ID CLONING [Abbas]'
    print 50* '-'
    print 'Codder.  : Abbas'
    print 'AUTHOR   : FARAZ KHAN'
    print 'Youtube :hhtpp/lodwa-channanale-h '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;93m[lol-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(Abbas)Open After 03 Days]\x1b[0m \n'
